...
Private Sub cmd_Zakoncz_Click() 'zakoñcz

Unload UserForm2

End Sub

Public Sub cmd_Znajdz_Click() ' ZnajdŸ +
...
Else
    MsgBox ("Wyst¹pi³ b³¹d. Zamknij okno formularza i spróbuj ponownie.")
End If
...
Private Sub cmd_Usun_Click() 'Usuñ produkt+
If szuk > 0 Then
    Rows(szuk).Select
    Selection.Delete Shift:=xlUp
    MsgBox ("Towar usuniêty z listy")
Else
    MsgBox ("Usuniêcie niemo¿liwe.")
End If
...
Sub Test_wywo³ania()
MsgBox ("A jednak siê krêci!")
End Sub

''Procedury wspó³dzielone
