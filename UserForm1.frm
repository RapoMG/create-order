...
Dim Wiersz ' Zmienna wype³nienia w³aœciwego wiersza
Dim NaLiczbe As Double ' Aby kody towaru zapisa³o jako liczbê


' Spr. czy wype³niono pole kodu
If TextBox1.Text = "" Then
        MsgBox ("Brak wewnêtrznego kodu towaru.")
        Exit Sub
End If
...
'        MsgBox, który zapyta czy kontynuowaæ mimo braku kodu
'
'End If
...
' Usuniêcie dolnej ramki wiersza wybranej kategorii
...
If IsNumeric(TextBox1.Value) = False Then
    MsgBox ("Kod wewnêtrzny towaru musi byæ liczb¹.")
...
MsgBox ("Kod kreskowy towaru musi byæ liczb¹.")
End If
End Sub
